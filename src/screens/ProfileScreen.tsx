  ...
  if (!wallet.connected || !profile || !localStats) {
    return (
      <View className="flex-1 bg-[#0a0a1a] items-center justify-center p-6">
        ...
        <Text style={{ fontFamily: 'Bangers' }} className="text-[#888] text-center mt-4">Connect wallet to view profile</Text>
      </View>
    );
  }
    ...
    <ScrollView className="flex-1 bg-[#0a0a1a]">
      <View className="p-6">
        ...
        <View className="items-center mb-6">
          ...
          <Text style={{ fontFamily: 'Bangers' }} className="text-white text-2xl font-bold">{profile.username}</Text>
          <Text style={{ fontFamily: 'Bangers' }} className="text-[#888] text-sm mt-1">
        ...
        <View className="bg-[#1a1a2e] rounded-xl p-6 mb-6 border border-[#2a2a3e]">
          <View className="flex-row justify-between items-center mb-3">
            <View className="flex-row items-center">
              ...
              <Text style={{ fontFamily: 'Bangers' }} className="text-white text-xl font-bold ml-2">Level {profile.level}</Text>
            </View>
            <Text style={{ fontFamily: 'Bangers' }} className="text-[#888]">{xpToNextLevel} XP to next level</Text>
          </View>
          ...
          <View className="flex-row items-center justify-center">
            ...
            <Text style={{ fontFamily: 'Bangers' }} className="text-[#14F195] text-2xl font-bold ml-2">
        ...
        <View className="flex-row flex-wrap gap-3 mb-6">
          <View className="flex-1 min-w-[45%] bg-[#1a1a2e] rounded-xl p-4 border border-[#2a2a3e]">
            ...
            <Text style={{ fontFamily: 'Bangers' }} className="text-[#888] text-xs uppercase mt-2 mb-1">Total Matches</Text>
            <Text style={{ fontFamily: 'Bangers' }} className="text-white text-2xl font-bold">{profile.totalMatches}</Text>
          </View>

          <View className="flex-1 min-w-[45%] bg-[#1a1a2e] rounded-xl p-4 border border-[#2a2a3e]">
            <Ionicons name="stats-chart" size={20} color="#14F195" />
            <Text style={{ fontFamily: 'Bangers' }} className="text-[#888] text-xs uppercase mt-2 mb-1">Win Rate</Text>
            <Text style={{ fontFamily: 'Bangers' }} className="text-[#14F195] text-2xl font-bold">{winRate}%</Text>
          </View>

          <View className="flex-1 min-w-[45%] bg-[#1a1a2e] rounded-xl p-4 border border-[#2a2a3e]">
            <Ionicons name="flame" size={20} color="#FF6B6B" />
            <Text style={{ fontFamily: 'Bangers' }} className="text-[#888] text-xs uppercase mt-2 mb-1">Current Streak</Text>
            <Text style={{ fontFamily: 'Bangers' }} className="text-white text-2xl font-bold">{profile.currentStreak}</Text>
          </View>

          <View className="flex-1 min-w-[45%] bg-[#1a1a2e] rounded-xl p-4 border border-[#2a2a3e]">
            <Ionicons name="star" size={20} color="#FFD700" />
            <Text style={{ fontFamily: 'Bangers' }} className="text-[#888] text-xs uppercase mt-2 mb-1">Longest Streak</Text>
            <Text style={{ fontFamily: 'Bangers' }} className="text-white text-2xl font-bold">{profile.longestStreak}</Text>
          </View>
        </View>
        ...
        <View className="bg-[#1a1a2e] rounded-xl p-6 mb-6 border border-[#2a2a3e]">
          <View className="flex-row items-center justify-between mb-4">
            <Text style={{ fontFamily: 'Bangers' }} className="text-white text-xl font-bold">Card Collection</Text>
            <Ionicons name="albums" size={24} color={COLORS.primary} />
          </View>
          
          <View className="flex-row items-center justify-between">
            <Text style={{ fontFamily: 'Bangers' }} className="text-[#888]">Total Cards</Text>
            <Text style={{ fontFamily: 'Bangers' }} className="text-white text-xl font-bold">{profile.deck.length}</Text>
          </View>
        </View>

        {/* Badges */}
        <View className="mb-6">
          <Text style={{ fontFamily: 'Bangers' }} className="text-white text-xl font-bold mb-4">
          ...
          {profile.badges.length > 0 ? (
            <View className="flex-row flex-wrap gap-3">
              {profile.badges.map((badge) => (
                ...
                >
                  ...
                  <Text style={{ fontFamily: 'Bangers' }} className="text-white text-xs font-bold mt-2" numberOfLines={2}>
                    {badge.name}
                  </Text>
                  <Text style={{ fontFamily: 'Bangers' }} className="text-[#888] text-xs mt-1">{badge.rarity}</Text>
                </View>
              ))}
            </View>
          ) : (
            <View className="bg-[#1a1a2e] rounded-xl p-6 border border-[#2a2a3e] items-center">
              ...
              <Text style={{ fontFamily: 'Bangers' }} className="text-[#888] text-center mt-2">No badges earned yet</Text>
              <Text style={{ fontFamily: 'Bangers' }} className="text-[#888] text-center text-xs mt-1">
